...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[0], await this.getName(owner[0] + '@s.whatsapp.net'), 'WHATSAPP BOT', 'https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E', true],
         [owner[1], await this.getName(owner[1] + '@s.whatsapp.net'), 'JASA RUN', 'https://chat.whatsapp.com/Go9cBxSneUpGDbl6gKdF7E', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
